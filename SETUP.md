...
4. "R-012 참고해서 기획해줘"  — 레퍼런스 번호로 기획(릴스 대본 기획 도구가 있으면)
5. "되돌려줘"              — 뭔가 이상해지면

※ 앞으로는 이 폴더에서 claude 를 여세요:  cd creator-dashboard && claude
...
원데이클래스에서도 집과 똑같이 0단계부터 7단계까지 한 번에 완주한다. 강사가 슬라이드에 문장 두 개를 띄우면 수강생 전원이 순서대로 붙여넣는다.
